...
//creo un database fittizio per poter intercettare e fare le chiamate http.
...
export class InMemoryDataService implements InMemoryDbService {
  ...
  //Nel caso in cui si voglia svuotare l'array di utenti all'aggiunta di un utente nuovo il medoto ritornerà il nuovo utente con id 1
